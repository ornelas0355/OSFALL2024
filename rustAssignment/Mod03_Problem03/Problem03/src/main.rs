...
//In this section, we'll explore more advanced uses of structs 
//in Rust, particularly in conjunction with I/O operations. 
//We'll cover reading input from the console and from a file, 
//demonstrating how structs can be used to organize and manage 
//data in these scenarios.

//Reading from Console
//Here's an example of how to use a struct to store user input 
//from the console:
...
//Next, let's look at how to use a struct to 
//represent configuration data read from a file:
